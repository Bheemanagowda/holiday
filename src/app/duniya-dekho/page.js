...
import DuniyaDekhoLatestTour from "../../data/DuniyaDekhoLatestTour.json";


 export const metadata={
  title: "Dunia Dekho - Vision Fly Holidays",
  description:"Explore the beauty of world with Dunia Dekho  tours. Discover diverse cultures, stunning landscapes, and vibrant traditions. Book your unforgettable journey today!"
 }
function page() {
  return (
    <div className="my-24 w-full px-4 lg:w-11/12 lg:mx-auto overflow-x-hidden">
      ...
      <div className="lg:flex items-start gap-5 mt-12">
        <div className="lg:w-[74%]">
          {" "}
          <DestinationsPageIntro destinations={DuniyaDekhoIntro} />
        </div>
        <div className="lg:w-[26%] mt-10 lg:mt-0">
          <LatestTour latestTours={DuniyaDekhoLatestTour} />
